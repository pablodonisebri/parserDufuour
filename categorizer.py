...
class CiteCategorizer:
    def __init__(self, palabra):
        ...
        self.a1_lect_libros = {"Gen", "Gn", "Ex", "Lev", "Num", "Dt", "Jos", "Jue", "Rut", "1Sa",
                               "2Sa", "1Re", "2Re", "1Par", "2Par", "Esd", "Neh", "Tob",
                               "Jdt", "Est", "1Mac", "2Mac"}
        ...
        self.a3_lect_libros = {"Rom", "1Cor", "2Cor", "Ga", "Ef", "Flp", "Col", "1Tes", "2Tes",
                               "1Tim", "2Tim", "Tit", "Flm", "Heb", "Sant", "1Pe", "2Pe", "1Jn", "2Jn", "3Jn", "Jds", "Ap", "Act"}
    ...
    def normalize_cites(self, cites):
        ...
        for cite in cites:
            ...
            # Before appending, put it in a nice format
            # example: Mc1,11 -> Mc 1,11 or 1Jn4,18 -> 1Jn 4,18
            cite = re.sub(
                r"(\b\d?[A-Z][a-zA-Z]{1,})(\d+,\d+(?:-\d+)?"
                r"(?:;\d?[A-Z][a-zA-Z]*\d+,\d+(?:-\d+)?)*)",
                r"\1 \2", cite)
